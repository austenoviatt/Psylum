...
void Use::use(std::vector<std::string> result, Player* player) {
  ...
  if ( item == "poisoncoffee") {
  ...
  else std::cout << "Inventory does not contain that item." << std::endl;
  }
    ...
    if (player->inventory.hasItem("sedative") == true) {
      ...
      if (result.size() > 2) {
        ...
        cout << "You can't use the sedative like that." << endl;
    } else
      std::cout << "inventory does not contain that item." << std::endl;
  }
  else if (item == "worm") {
      if (player->inventory.hasItem("worm") == true){
          if (result.size() == 2){
            std::cout << "You can't use the worm like that." << std::endl;
          }
    ...
    if (result.size() == 2) {
      cout << "You drink the coffee. It is warm and comforting, but you can't help feeling like you should have done something else with it." << endl;
      ...
      cout << "You can't use the coffee like that. " << endl;
  }
  else
    std::cout << "Inventory does not contain that item." << std::endl;
  }
    ...
    if (result.size() == 2)
      cout << "You can't use the rat poison like that." << endl;
    ...
    if (player->inventory.hasItem("magnet") == true) {
      if (result.size() == 2)
        cout << "You can't use the magnet like that." << endl;
    ...
    if (player->inventory.hasItem("fishingrod") == true) {
      if (result.size() == 2)
        cout << "You can't use the fishing rod like that." << endl;
    ...
    std::cout << "Inventory does not contain this item." << endl;
  }
  else if (item == "magnetrod") {
    if (player->inventory.hasItem("magnetrod") == true) {
      if (result.size() == 2)
        cout << "You can't use the magnet rod that." << endl;
    ...
    if (player->currentRoom->inventory.hasItem("journal") == false) {
      ...
      std::cout << "You can't use the journal like that." << endl;
    else {
