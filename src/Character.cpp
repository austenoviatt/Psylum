...
Character::Character(std::string a, std::string b, std::string c, bool d, int e, std::string f) {
charaID = a;
name = b;
description = c;
isAlive = d;
...
void Character::talk() {
	if (isAlive == false) {
		...
		if (charaID == "traitor") {
			...
			std::cout << "Well, well, well. We got a little escapee here. GUARDS! Take him back to his cell!!!" << "\n";
			...
			std::cout << "You there! Are you a newbee here in the hospital?" << "\n";
				...
				std::cout << "Ah, nice to see a new face here. Anyways, as you can see I'm a busy man, go make me a cup of coffee." << "\n";
					//this dialogue get's repeated over and over again, eventCounter at this point stays 0 until player brings him the coffee
					std::cout << "Remember, I'm very picky when it comes to coffee, I need exactly 10g of sugar, 35ml of cream with 415ml of coffee, now hurry up!" << "\n";
				...
				std::cout << "Well, well, well. We got a little escapee here trying to dress up for Halloween. GUARDS! Take him back to his cell!!!" << "\n";
		}
